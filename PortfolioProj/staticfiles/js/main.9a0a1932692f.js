    ...
    class Portfolio {
        constructor() {
            ...
            this.projects = [  //3.放入project相關資訊
                ...
                {
                    projId: 'projB4', buttonName: 'Python<br>[Numpy]', title: 'New RC-PM', subTitle: 'Developed By Python Numpy', url: 'https://newrcpm.com/', firstFloorImg: '/static/newrcpm/newrcpm.PNG', secondFloorImg: '/static/newrcpm/python.svg', icon: '/static/newrcpm/python.svg',
