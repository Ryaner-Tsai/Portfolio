    ...
    class Portfolio {
        constructor() {
            ...
            this.projects = [  //3.放入project相關資訊
                ...
                {
                    projId: 'projB4', buttonName: 'Javascript<br>[Vue.js]', title: 'Calculator', subTitle: 'Developed By Javascript Vue.js', url: '/calculator', firstFloorImg: '/static/calculator/calculator.png', secondFloorImg: '/static/calculator/jsIcon.png', icon: '/static/calculator/jsIcon.png',
                ...
                },
                {
                    ...
                    intro: `(Only For Computer User/No RWD)Nec RC-PM is a web app created based on python numpy library, and is used to analysis the P-M curve of RC & New RC column. This app also use chart.js to plot the P-M curve diagram. Currently, all service in this app are free!`,
