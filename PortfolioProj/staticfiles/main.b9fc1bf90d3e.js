...
class Protfolio {
    constructor() {
        ...
        this.projects = [
            ...
            },
            {
                ...
                intro: `A classic snake game created by plain JavaScript (no libraries or frameworks)!
                ...
                detailImgList: ['/static/snakeCode.PNG', '/static/snakeTitleImg.png']
            },
            {
                ...
                detailImgList: ['/static/getip/getip3.png', '/static/getip/getipCode.PNG']
            },
            {
                ...
                intro: `Nec RC-PM is a web app created based on python numpy library, and is used to analysis the P-M curve of RC & New RC column. This app also use chart.js to plot the P-M curve diagram. Currently, all service in this app are free!`,
                detailImgList: ['/static/newrcpm/newrcpm.PNG', '/static/newrcpm/pmcurve.png']
            }
        ];
    ...
    renderModal(id) {
        ...
        //detailImgList
        let slideStr = '';
        proj.detailImgList.forEach((ele) => {
            slideStr += `	<li class="glide__slide" style="width:30px">
                                     <div>
                                        <img src="${ele}" alt="CSS" onclick="document.getElementById('${this.idList.connect}').click()">
                                    </div>
                                 </li>`
        });
        $('.' + this.classList.glide).empty();
        $('.' + this.classList.glide).html(slideStr);
